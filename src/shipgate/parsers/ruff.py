...
from shipgate.parsers.base import register
from shipgate.parsers.common import strip_ansi
from shipgate.parsers.patterns import DiffTextParser, JsonListParser
...
class RuffFormatParser(DiffTextParser):
    ...
    def _file_from_line(self, line: str, current_file: str | None) -> str | None:
        if line.startswith("Would reformat:"):
            return strip_ansi(line.split(":", 1)[1].strip())
