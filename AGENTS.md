...
pyossmtool is a portable quality-gate orchestrator (inspired by Trunk and pre-commit) for Python-first repositories with opinionated defaults and little required configuration.
